...
from .network_astrous import Network_astrous


class ResNet50_astrous_concat(Network_astrous):

    def setup(self):
        print("\n------------------------------------------")
        print("** Network Structure Define **")
        (self.feed('data')
        ...
        (self.feed('bn4a_branch1', 'bn4a_branch2c')
         ...
         .atrous_conv(3, 3, 256, 4, padding='SAME', biased=False, relu=False, name='res4b_branch2b')
        ...
        (self.feed('res4a_relu', 'bn4b_branch2c')
         ...
         .atrous_conv(3, 3, 256, 8, padding='SAME', biased=False, relu=False, name='res4c_branch2b')
        ...
        (self.feed('res4c_relu', 'bn4d_branch2c')
         ...
         .atrous_conv(3, 3, 256, 4, padding='SAME', biased=False, relu=False, name='res4e_branch2b')
        ...
        (self.feed('res4d_relu', 'bn4e_branch2c')
         ...
         .atrous_conv(3, 3, 256, 8, padding='SAME', biased=False, relu=False, name='res4f_branch2b')
        ...
        (self.feed('res5b_relu', 'bn5c_branch2c')
         ...
         .conv(1, 1, 512, 1, 1, biased=True, relu=False, name='layer1')
         .batch_normalization(relu=False, name='layer1_BN')
         .up_project([3, 3, 512, 256], id='2x', stride=1, BN=True)
         .relu(name='layer2x_relu'))

        (self.feed('res2c_relu', 'layer2x_relu')
         .concat(axis=-1, name='layer2x_concat')
         .conv(3, 3, 256, 1, 1, biased=False, relu=False, padding='SAME', name='layer2x_concat_conv')
         .batch_normalization(relu=True, name='layer2x_concat_conv_BN')
         .up_project([3, 3, 256, 128], id='4x', stride=1, BN=True)
         .relu(name='layer4x_relu'))

        (self.feed('bn_conv1', 'layer4x_relu')
         .concat(axis=-1, name='layer4x_concat')
         .conv(3, 3, 128, 1, 1, biased=False, relu=False, padding='SAME', name='layer4x_concat_conv')
         .batch_normalization(relu=True, name='layer4x_concat_conv_BN')
